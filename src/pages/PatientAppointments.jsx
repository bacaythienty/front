            ...
            >
              ...
              {activeTab === 'upcoming' && app.status !== 'cancelled' && (
                <Button
                  variant="outline"
                  size="sm"
                  className="text-red-600 hover:text-red-700 hover:bg-red-50/50 border-red-200 self-start md:self-center shrink-0 flex items-center gap-1.5 font-bold rounded-xl text-xs py-2 px-4.5"
